...
/**
 * Minimal shim for obsidian's CachedMetadata — keeps domain/utils
 * free of obsidian imports while remaining structurally compatible.
 */
...
/**
 * Minimal shim for obsidian's TFile — only the fields domain code needs.
 */
